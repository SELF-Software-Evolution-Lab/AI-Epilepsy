...
def display_metrics(y_true, y_pred):
    ...
    disp.plot()
    conf_name='FCN1Confusion.png'                                      # Conf file name
...
def FCN(fileSeizure, fileNoSeizure):
    ...
    # Estandarizar
    scaler_name='FCN1Scaler.pkl'                               # Scaler file name 
    sc = StandardScaler()
    ...
    model.add(BatchNormalization())
    model.add(MaxPooling2D((1, 4), padding='same'))
    model.add(Conv2D(8, (3, 3), activation='relu', padding='same', kernel_regularizer=l2(0.01)))
    model.add(BatchNormalization())   
    model.add(MaxPooling2D((1, 4), padding='same'))
    ...
    model_filename = 'FCN1.h5'                                                     # Model File Name
    ...
    plt.ylabel('Loss')
    plt.legend()
    LossEpoch_name='FCN1LossEpoch.png'                                      # LossEpoch file name
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    AccEpoch_name='FCN1AccEpoch.png'                                      # AccEpoch file name
