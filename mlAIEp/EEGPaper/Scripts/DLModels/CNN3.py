...
def display_metrics(y_true, y_pred):
    ...
    disp.plot()
    conf_name='3CNN1Confusion.png'                                      # Conf file name
...
def FCN(fileSeizure, fileNoSeizure):
    ...
    # Estandarizar
    scaler_name='3CNN1Scaler.pkl'                               # Scaler file name 
    sc = StandardScaler()
    ...
    model.add(Conv2D(filters=16, kernel_size=(1, 20), activation='relu', padding='same'))
    model.add(MaxPooling2D(pool_size=(2, 1)))
    model.add(Conv2D(filters=32, kernel_size=(1, 20), activation='relu', padding='same'))
    model.add(MaxPooling2D(pool_size=(2, 1)))
    model.add(Conv2D(filters=64, kernel_size=(1, 10), activation='relu', padding='same'))
    model.add(MaxPooling2D(pool_size=(2, 1)))
    ...
    model_filename_CP = '3CNN1Grid.h5'
    ...
    model_filename = '3CNN1.h5'                                                     # Model File Name
    ...
    plt.ylabel('Loss')
    plt.legend()
    LossEpoch_name='3CNN1LossEpoch.png'                                      # LossEpoch file name
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    AccEpoch_name='3CNN1AccEpoch.png'                                      # AccEpoch file name
