...
import FullScreenToggle from './Toolbars/FullScreen.jsx';
import UiModalText from './Modals/UiModalText.jsx';
import UiModalAlert from './Modals/ModalAlert.jsx';
import UiErrConsole from './UiErrConsole.jsx';
import ModeView from '../store/ViewMode.js';
import Graphics2d from '../engine/Graphics2d.jsx';
import BrowserDetector from '../engine/utils/BrowserDetector.js';
import UIProgressBar from './ProgressBar/UIProgressBar.jsx';
import Graphics3d from '../engine/Graphics3d.jsx';
import ZoomTools from './UiZoomTools.jsx';
import {useDrop} from 'react-dnd';
import {DnDItemTypes} from './Constants/DnDItemTypes.js';
import {Header} from './Header/Header.jsx';
import {RightPanel} from './Panels/RightPanel.jsx';
import Spinner from './ProgressBar/UISpinner.jsx';
                ...
                <div ref={drop} style={{height: '100%'}}>
                    ...
                    {isReady && (
                        <div className={cx(isFullMode && css.fullscreen)}>
                            ...
                            <div className={css.center}>{viewMode === ModeView.VIEW_2D ? <Graphics2d/> :
                                <Graphics3d/>}</div>
                    ...
                    {showModalText && (
                        <UiModalText stateVis={showModalText} onHide={onHideModalText.bind(this)}
