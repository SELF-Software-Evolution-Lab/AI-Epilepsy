...
import RecentlyFiles from '../RecentlyFiles/RecentlyFiles.jsx';
import {UIButton} from '../../Button/Button.jsx';

import {connect} from 'react-redux';
import css from './SmartContainer.module.css';
import {SVG} from '../../Button/SVG.jsx';
import UiModalDemo from '../../Modals/ModalDemo.jsx';
import UiModalWindowCenterWidth from '../../Modals/UiModalWinCW.jsx';
import FileReader from '../../../engine/loaders/FileReader.js';
import {UiSaveMenu} from '../../OpenFile/UiSaveMenu.jsx';
import {UiReportMenu} from '../../OpenFile/UiReportMenu.jsx';
import UIModalUrl from '../../Modals/ModalUrl.jsx';
        ...
        return (
            ...
            >
                ...
                <div className={css.buttons_toolbar}>
                    ...
                    />
                    <UIButton icon="link" text="Open From URL" handler={this.onModalUrlShow}
                              cx={css.button_start_screen}/>
                    <UIButton icon="grid" text="Demo Data" handler={this.onModalDemoOpenShow}
                              cx={css.button_start_screen}/>
                </div>
                <RecentlyFiles/>
                {this.props.isLoaded && (
                ...
                {this.state.showModalUrl && (
                    <UIModalUrl stateVis={this.state.showModalUrl} onHide={this.onModalUrlHide}
                                loadUrl={this.onClickLoadUrl}/>
                )}

                {this.state.showModalDemo && (
                    <UiModalDemo stateVis={this.state.showModalDemo} onHide={this.onModalDemoOpenHide}
