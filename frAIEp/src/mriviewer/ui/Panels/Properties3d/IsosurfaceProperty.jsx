...
import {SliderCaption, SliderRow} from '../../Form/index.js';
...
export function IsosurfaceProperty() {
    ...
    return (
        <>
            ...
            <SliderRow>
                <Nouislider onChange={onChange} range={{min: 0.0, max: 1.0}} value={isoThresholdValue}
                            connect={[true, false]} step={0.00001}/>
            </SliderRow>
        </>
    );
}
