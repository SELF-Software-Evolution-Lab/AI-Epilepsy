...
import {getPalette} from '../../../engine/loaders/RoiPaletteItems.js';
    ...
    return (
        <>
            ...
            <FormGroup row style={{height: '300px', overflowY: 'auto'}}>
                <FormControlLabel control={<Checkbox onChange={selectAll}/>}
                                  label={isSelectedAll ? 'Select none' : 'Select all'}/>
