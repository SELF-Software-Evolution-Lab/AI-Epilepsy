...
import GaussSmoother from '../../engine/imgproc/Gauss.js';
...
import {Modal, ModalBody, ModalFooter, ModalHeader} from './ModalBase.jsx';
        ...
        return (
            <Modal isOpen={stateVis} close={onHideFunc}>
                ...
                <ModalBody>
                    ...
                    <Nouislider onChange={this.onChangeSliderKoefDist.bind(this)} range={{min: 0.5, max: 3.0}}
                                value={defaultDist} step={0.00001}/>
                    Select koefficient value (kv)
                    <Nouislider onChange={this.onChangeSliderKoefVal.bind(this)} range={{min: 0.1, max: 4.0}}
                                value={defaultVal} step={0.00001}/>
                    <p>
