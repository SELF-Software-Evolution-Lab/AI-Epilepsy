...
import { UiSaveMenu } from './UiSaveMenu.jsx';
import { UiReportMenu } from './UiReportMenu.jsx';
...
class UiOpenMenu extends FileReader {
    ...
    onFileContentReadMultipleHdr() {
        ...
        if (this.m_numFiles !== VALID_NUM_FILES_2 && this.m_numFiles !== VALID_NUM_FILES_4) {
            console.log(
                `onFileContentReadMultipleHdr: can read ${VALID_NUM_FILES_2} or ${VALID_NUM_FILES_4} files for multiple hdr loader`
            );
            return;
        }
        ...
        if (FileTools.isValidUrl(strUrl)) {
            ...
            if (strUrl.endsWith('.ktx')) {
                ...
                if (READ_DICOM_VIA_DAIKON) {
                    ...
                    return loaderUrlDcm.readFromUrl(
                        this.m_volumeSet,
                        strUrl,
                        this.callbackReadCompleteUrlKtxNii,
                        this.callbackReadProgress
                    );
                }
